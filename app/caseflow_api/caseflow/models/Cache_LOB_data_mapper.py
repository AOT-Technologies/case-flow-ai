...
class CacheLOBDataMapper(BaseModel, db.Model):  # pylint: disable=too-many-public-methods
    """This class manages CaseDocuments against each form."""
    __tablename__ = "CacheLOBDataMapper"
    id = db.Column(db.Integer, primary_key=True)
    cachedatafieldid = db.Column(
        db.String(100), nullable=True
    )
    lobdatafieldid = db.Column(db.String(100), nullable=True)    