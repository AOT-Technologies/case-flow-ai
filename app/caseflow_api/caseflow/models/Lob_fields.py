...
class LobFields(BaseModel, db.Model):  # pylint: disable=too-many-public-methods
    """This class manages LobFields against each form."""
    __tablename__ = "LobFields"
    ...
    displayrow = db.Column(db.String(100), nullable=True)
